...
INSERT INTO Pret values ('2362sec5', '2022-11-10', '2022-12-10', NULL, NULL, '145678sf3', '[{"login":"rouaug", "motDePasse":"rrrji2KE3", "nom":"Roullet", "prenom":"Augustin", "adresse":"15 Rue des Lombards, 60200 Compiègne", "email":"alex43@yahoo.fr", "dateNaissance":"2002-06-21", "telephone":"0630572933","adhesion":"true","blacklist":"false","droitPret":"true}]');
...
'2022-12-08',
'2023-03-01',
'[{"login":"rouaug", "motDePasse":"rrrji2KE3", "nom":"Roullet", "prenom":"Augustin", "adresse":"15 Rue des Lombards, 60200 Compiègne", "email":"alex43@yahoo.fr", "dateNaissance":"2002-06-21", "telephone":"0630572933","adhesion":"true","blacklist":"false","droitPret":"true}]'
'2362sec5'
);
...
adherent->>'adresse' AS adresse,
adherent->>'email' AS email,
adherent->>'dateNaissance' AS dateNaissance,
adherent->>'telephone' AS telephone,
FROM Pret
WHERE adherent->>'login'='hasyou';
...
adherent->>'telephone' AS telephone,
FROM Pret
WHERE adherent->>'nom'='Roullet' AND adherent->>'nom'='Augustin';

--Afficher si un adherent est blacklisté ou pas ::
SELECT MAX(blackliste)
FROM Pret
WHERE adherent->>'login'='hongjul'
ORDER BY dateRetourReelle;

--Afficher si un adhérent peut emprunter
SELECT MAX(droitPret)
FROM Pret
WHERE adherent->>'login'='hongjul'
ORDER BY dateRetourReelle;
...
--Afficher les informations d'un auteur
SELECT
contributeur->>'nom' AS nom,
contributeur->>'prenom' AS prenom,
contributeur->>'dateNaissance' AS dateNaissance,
contributeur->>'nationalite' AS nationalite,
FROM AEcrit
WHERE adherent->>'nom'='Rowling' AND adherent->>'prenom'='Joanne';
